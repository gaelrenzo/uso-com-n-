...
echo -e "\e[33m🔄 Sincronizacion de Skills:\e[0m"
echo -e "  \e[32mskills-sync\e[0m = Descarga y enlaza skills de agentes"
echo -e "  \e[32mskills-push\e[0m = Sube skills locales (Modo Seguro: Solo Agregar)\n"

echo -e "\e[33m🤖 Directorios de Agentes:\e[0m"
...
echo -e "\e[33m💡 Como usar la Sincronizacion:\e[0m"
echo -e "  1. Sube tus cambios locales:  \e[32mskills-push \"mensaje\"\e[0m"
echo -e "  2. Descarga en otros equipos: \e[32mskills-sync\e[0m"
echo -e "\e[35m=====================================================\e[0m"
